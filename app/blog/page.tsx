        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredPosts.filter(p => !p.featured).map(post => (
              <Link key={post.id} href={`/blog/${post.id}`} className={`block rounded-xl overflow-hidden border-l-2 pl-8 transition-all hover:-translate-y-1 ${isDark ? "bg-[#181A1E] border-[#A0AEC0]" : "bg-white border-gray-400"}`}>
