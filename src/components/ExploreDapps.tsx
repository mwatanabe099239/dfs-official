...
const ExploreDapps: React.FC = () => {
  ...
  const dappsData = [
    ...
    },
    {
      ...
      category: "DeFi",
      url: null,
      logoWhite: "https://res.cloudinary.com/dgpzwljmv/image/upload/v1768030455/B2E_logo_jtzmdu.png",
      logoBlack: "https://res.cloudinary.com/dgpzwljmv/image/upload/v1768030455/B2E_logo_jtzmdu.png",
